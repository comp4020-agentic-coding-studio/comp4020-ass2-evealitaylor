...
//
// Level 6: the course is postgraduate because the labour question in it needs
// students who have already been employed somewhere.
export const courseMeta = slopCourseMetaSchema.parse({
  code: "SLOP6531",
  title: "The Unpaid Shift",
  session: "Semester 1",
  year: 2027,
  level: 6,
  ...
  endDate: "2027-05-28",
  description:
    "Wikipedia, every subreddit and half of open source are maintained by " +
    "volunteers doing unpaid janitorial work under rules nobody wrote down. " +
    "Twelve weeks doing that work for real: editing, moderating, arbitrating, " +
    "and handing the mop on to whoever comes next.",
  tags: ["online communities", "moderation", "volunteer labour"],
